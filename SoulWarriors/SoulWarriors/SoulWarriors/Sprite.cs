...
namespace SoulWarriors
{
    class Sprite
    {
        ...
        //Collision checing for the sprites rectangel
        public bool IsBoxColliding(Rectangle OtherBox)
        {
            return BoundingBoxRect.Intersects(OtherBox);
        }

        //Collision checing for the sprites (costume) radius
        ...
        public void AddFrame(Rectangle frameRectangel)
        {
            frames.Add(frameRectangel);
        }

        //switches frames and keeping track of position
